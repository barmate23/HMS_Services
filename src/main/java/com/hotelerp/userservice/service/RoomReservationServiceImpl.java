...
public class RoomReservationServiceImpl implements RoomReservationService {
        ...
        public StandardResponse<RoomReservationDTO> getActiveReservationByRoomId(Long roomId) {
                try {
                        ...
                        // 2. Find active booking for today where date is between Reservation's
                        ...
                        RoomReservationDTO dto = RoomReservationDTO.builder()
                                        ...
                                        .floorName(booking.getRoom() != null && booking.getRoom().getFloor() != null
                                                        ? booking.getRoom().getFloor().getFloorNumber()
                                                        : null)
                                        ...
                                        .numberOfNights(booking.getNumberOfNights() != null
                                                        ? booking.getNumberOfNights()
                                                        : (reservation != null ? reservation.getNumberOfNights()
                                                                        : null))
                                        ...
                                        .organisationName(
                                                        reservation != null ? reservation.getOrganisationName() : null)
                                        ...
                                        .bookingReference(
                                                        reservation != null ? reservation.getBookingReference() : null)
